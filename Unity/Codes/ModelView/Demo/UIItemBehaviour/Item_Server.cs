		...
		public UnityEngine.UI.Text EText_ServerNameText
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_EText_ServerNameText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"EText_ServerName");
     				}
     				return this.m_EText_ServerNameText;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"EText_ServerName");
     			}
     		}
     	}
